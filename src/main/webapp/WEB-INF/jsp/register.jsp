	...
	<section id="registration" class="section">
	 ...
	 <em>Register User</em><br/>
    		 <form:form method="post" action="/registeruser" modelAttribute="newuser" >
				...
				<form:radiobutton path="activity" name="activity" id="activity" value="sport"/>Play a Sport?
				<form:radiobutton path="activity" name="activity" id="activity" value="Gym"/>Hit the Gym?
